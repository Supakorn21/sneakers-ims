...
class AddForeignKeyToProductsSchema extends Schema {
  up() {
    ...
    ADD CONSTRAINT fk_brand_id_products  FOREIGN KEY (brand_id) REFERENCES brands(id)
    `);
    this.raw(`
     ALTER TABLE products 
    ADD CONSTRAINT fk_user_id_products FOREIGN KEY (user_id) REFERENCES users(id)
    `);
  }
